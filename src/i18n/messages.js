...
const messages = {
  'pt-BR': {
    ...
    routeTitles: {
      login: 'Sistema de Operações OPENBLAST',
    ...
    header: { eyebrow: 'OPENBLAST // Sistema de Operações', subtitle: 'Operação de UMR em tempo real' },
    navigation: {
  ...
  'en-US': {
    ...
    routeTitles: { login: 'OPENBLAST Operations System', operator: 'Operator panel', dashboard: 'Fleet dashboard', registrations: 'Operational base', export: 'Data and export', settings: 'System administration', default: 'Time and Motion System' },
    header: { eyebrow: 'OPENBLAST // Operations System', subtitle: 'Real-time UMR operation' },
  ...
  'zh-CN': {
    ...
    routeTitles: { login: 'OPENBLAST 运营系统', operator: '操作员面板', dashboard: '车队看板', registrations: '运营基础', export: '数据与导出', settings: '系统管理', default: '工时与运转系统' },
    header: { eyebrow: 'OPENBLAST // 运营系统', subtitle: 'UMR 实时作业' },
    ...
    login: { hero: { eyebrow: 'OPENBLAST // 现场控制', title: '车队时间，清晰可见。', copy: '选择角色。确认密码。继续作业。', chips: { roles: '按角色分配', sync: '实时同步', offline: '可离线运行' }, stats: { operators: '操作员', clients: '客户', managers: '经理', active: '启用' }, brand: '运营系统' }, form: { eyebrow: '安全登录', title: '选择角色', status: '已授权访问', empty: '没有可用的活动用户。', password: '密码', passwordPlaceholder: '请输入密码', submit: '登录系统' }, errors: { generic: '登录失败。' } },
