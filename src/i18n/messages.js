...
const messages = {
  'pt-BR': {
    ...
    roles: { operator: 'Operador', client: 'Cliente', manager: 'Gerente' },
  ...
  'en-US': {
    ...
    roles: { operator: 'Operator', client: 'Client', manager: 'Manager' },
  ...
  'zh-CN': {
    ...
    roles: { operator: '操作员', client: '客户', manager: '经理' },
